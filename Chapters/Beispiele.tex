...
\end{figure}
Mit der scale könnt ihr die Größe vom Bild ändern.
...
\end{lstlisting}
Abgesehen von farbänderungen ist das highlighten von Keywords der einzige Grund wieso ihr in die .sty Datei müsst. Dort gibt es in der CUSTOM COMMANDS \& MACROS -Section einen Bereich \textbackslash lstdefinelanguage\{csharp\}
\begin{figure}[H]
\centering
    \includegraphics[scale=0.65]{Images/Screenshot_sty.png}
    \caption{Codeblock styling}
\end{figure}
\noindent Hier könnt ihr Keywords ergänzen, je nach dem welche Farbe der Text dann haben soll, und er wird im Codeblock gefärbt.
\begin{tcolorbox}[infoBox]
        \textcolor{red}{\textbf{NOTE}}: z.Z. ist es noch etwas buggy und manchmal werden sie, obwohl sie in der Liste sind, nicht gehighlightet...
\end{tcolorbox}
